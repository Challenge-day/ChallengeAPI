...
from sqlalchemy import String, Boolean, Integer, DateTime, ForeignKey, func, BigInteger, Float
...
class User(Base):
    ...
    def __init__(self, telegram_id, first_name, last_name, username, language_code='', created_at=None,
                 updated_at=None):
